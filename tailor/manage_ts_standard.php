							...
							<div class="col-md-4">
								<div class="input-group">
									<div class="input-icon">
										...
										<input type="email" class="form-control" name="email" placeholder="Search user by email">
									</div>
			...
			<div class="portlet-body form">
              ...
              <div class="row">
  							<div class="col-md-4">
  								...
  								<div class="col-md-4">
  									<input type="number" id="measurement_type_{{ x.measurement_type_id }}" class="form-control" style="width:100px;" onchange="changedMeasurement()">
  								</div>
  							</div>
                <div class="col-md-4">
                  <label class="col-md-8 control-label">{{ dataset_measurement_types[$index+1].measurement_type_name }}</label>
                  <div class="col-md-4">
                    <input type="number" id="measurement_type_{{ dataset_measurement_types[$index+1].measurement_type_id }}" class="form-control" style="width:100px;" onchange="changedMeasurement()">
                  </div>
                </div>
              </div>
						</div>						
