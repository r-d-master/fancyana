<?php include 'commonhead.php';?>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      var garmentPickupRequired = parseInt(localStorage.order_alt_pickup_required_garment);
      var measurementPickupRequired = parseInt(localStorage.order_alt_pickup_required_measurement);
      TSAddresses.pickupRequired = garmentPickupRequired + measurementPickupRequired;
      localStorage.order_alt_pickup_required = TSAddresses.pickupRequired;
    ...
    function tapNewOrderNext5() {
      ...
      if(!!odate && !!opadd && !!odadd) {
        localStorage.order_alt_pickup_date = odate;
        localStorage.order_alt_pickup_address = opadd;
        localStorage.order_alt_pickup_address_details = JSON.stringify(TSAddresses.address[opadd]);
        localStorage.order_alt_delivery_address = odadd;
        localStorage.order_alt_delivery_address_details = JSON.stringify(TSAddresses.address[odadd]);
        window.location.href="neworderalt6.php";                  
      } else {
    ...
    function newOrderPickupAddressChange() {
        ...
        localStorage.setItem('order_alt_pickup_address', pickupAddressVal);
    ...
    function newOrderDeliveryAddressChange() {
        ...
        localStorage.setItem('order_alt_delivery_address', deliveryAddressVal);
...
<body>
  ...
  <!-- Begin Content -->
  <section id="alteration5" ng-app="newOrder5DataApp" ng-controller="newOrder5DataCtrl">
              ...
              <div>
                <div class="alt-checkout-wrap">
                  <ul class="alt-checkout-bar">
                    ...
                    <li class="active"><a href="neworderalt5.php">Pickup/Delivery</a></li>
                    <li class="">Confirm</li>
                  </ul>
                </div>
                ...
                <div class="row">
                  ...
                  <form id="neworder_address" class="form-horizontal">
                    <div class="form-body">
                      ...
                      <div class="form-group" id="neworder_pickup_date_div">
