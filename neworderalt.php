  ...
  <script>
    ...
    function tapNewOrderNext1() {
      ...
      if (!!dressIdVal){
        ...
        localStorage.setItem('order_alt_dress_id', dressIdVal);
        localStorage.setItem('order_alt_dress_string', dressNameVal);
        localStorage.setItem('order_alt_dress_price', dressPriceVal);
...
<body>
  ...
  <!-- Begin Content -->
  <section id="alteration1" ng-app="newOrderDataApp" ng-controller="newOrderDataCtrl">
        ...
        <div class="modal-content" style="width:400px">
          ...
          <div class="modal-body">
            <form id="specialorderform" class="tsforminmodal">
              ...
              <input type="hidden" id="special_order_order_type" name="order_type" value="Alteration">
              ...
              <div>
                <div class="alt-checkout-wrap">
                  <ul class="alt-checkout-bar">
                    <li class="active"><a href="neworderalt.php">Dress</a></li>
                    <li class="">Garment</li>
