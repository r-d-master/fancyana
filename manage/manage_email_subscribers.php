...
<script>
  ...
  backdashDataApp.controller('backdashDataCtrl', function($scope, $http) {
    ...
    $http.post('../api/v1/getallsubscribers', data, config)
...
<div class="row" ng-app="backdashDataApp" ng-controller="backdashDataCtrl">
	<div class="col-md-12">
		<div class="portlet downloadlistblock">
			<a href='#' onclick='downloadCSV({ filename: "tailorsquare_subscribers.csv" });' class="btn green tooltips" data-container="body" data-placement="bottom" data-original-title="Export as the popular CSV format. Use this for importing in an Email program"><i class="fa fa-download"></i> Export as CSV</a>
			<a href='#' onclick='downloadCSList({ filename: "tailorsquare_subscribers.txt" });' class="btn green tooltips" data-container="body" data-placement="bottom" data-original-title="Export as a comma seperated text file. Use this to copy paste in an Email program's to or bcc Field"><i class="fa fa-download"></i> Export as List</a>
		</div>
