...
<script>
  ...
  backdashDataApp.controller('backdashDataCtrl', function($scope, $http) {
      ...
      $http.post('../api/v1/getordersandextrasfora', data, config)
      .success(function (data, status, headers, config) {
        ...
        $scope.pickupString = {
  	    	"0": "No",
  	    	"1": "Garment",
  	    	"2": "Garment from E-Commerce", 
  	    	"4": "Measurement Garment",
  	    	"5": "Garment & Measurement Garment",
  	    	"6": "Garment from E-Commerce & Measurement Garment"
        }
    ...
    function applyFilter(filterId) {
      ...
      window.location.href="manage_orders_alteration.php?status="+filterString;
    };

</script>
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
Manage Alteration Orders
</h3>
<!-- BEGIN PAGE CONTENT-->
	...
	<div class="col-md-12">
		<div class="portlet box red">
			...
			<div class="portlet-body table-scrollable">
              ...
              <td><a href="manage_order_status.php?order_id={{ x.order_id }}&order_type=2" class="btn red"><span class="glyphicon glyphicon-edit"></span> Update</a></td>
						</tr>
					</tbody>
				</table>
			</div>
