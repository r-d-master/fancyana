...
<body>
  ...
  <section id="registration_successful">
    <div class="container align-to-center">
      <div class="col-lg-12">
        <h3 class="clients-title">Activation Pending</h3>
        ...
        <hr />
        <p style="font-size: 0.9em; margin-bottom:10px;">Can't find the email? Check your spam folder or click the button below to resend the activation link.</p>
