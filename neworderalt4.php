<?php include 'commonhead.php';?>
  ...
  <script>
    ...
    $(document).ready(function() {
        localStorage.removeItem("order_alt_measurement_set_id");
    ...
    function tapNewOrderNext4() {
      var measurementMethodChecked = localStorage.order_alt_measurement_method;
      ...
      localStorage.order_alt_pickup_required_measurement = measurementPickupRequired[measurementMethodChecked];
      ...
      localStorage.order_alt_measurement_type_names = JSON.stringify(order_measurement_type_names);
      localStorage.order_alt_measurement_type_ids = JSON.stringify(order_measurement_type_ids);
      ...
      if(measurementMethodChecked == 1) {
        ...
        localStorage.order_alt_measurements = JSON.stringify(order_measurements);
    ...
    function selectGarment(garment_img_tag) {
      ...
      localStorage.order_alt_measurement_set_id = mgarmentIdVal;
    }
    ...
    function loadGarmentMeasurementVals(mgset_id) {
      if (TSMeasurement.mgarmentsFound) {
        ...
        if (!!mvals) {
          ...
          localStorage.order_alt_measurements = JSON.stringify(mvals);          
        }
      }
    }
    ...
    function selectMeasurementMethodTab(measurementMethodTab) {
      ...
      localStorage.order_alt_measurement_method = measurementMethodChecked;
    }
...
<body>
  ...
  <!-- Begin Content -->
  <section id="alteration4" ng-app="newOrder4DataApp" ng-controller="newOrder4DataCtrl">
              ...
              <div>
                <div class="alt-checkout-wrap">
                  <ul class="alt-checkout-bar">
                    ...
                    <li class="active"><a href="neworderalt4.php">Measurements</a></li>
