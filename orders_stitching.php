    ...
    <script>
      ...
      stitchingOrdersDataApp.controller("stitchingOrdersDataCtrl", function ($scope, $http) {
       // use $.param jQuery function to serialize data from JSON 
        ...
        $http.post('api/v1/getordersandextrasforsbyuser', data, config)
    ...
    <div class="container">
      <div class="col-lg-2">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li role="presentation" class="active"><a href="orders_stitching.php">Stitching Orders</a></li>
          <li role="presentation"><a href="orders_alteration.php">Alteration Orders</a></li>
      ...
      <div class="col-lg-10 align-to-center">
        <h3 class="clients-title">Stitching Orders</h3>
        <hr />
